...
- [Material deletion/recovery](material-recovery.md): future lifecycle lane; thùng rác, restore-to-review, purge race, shared bytes và backup, chưa runtime/retention policy.
